...
namespace Dewey_Training.Pages
{
    ...
    public partial class ReplaceBooks : Page
    {
        ...
        // Correct Order
        public static List<DeweyDecimal> orderedDeweyDecimals = new List<DeweyDecimal>();
        ...
        private List<DeweyDecimal> AlphabetOrder(List<DeweyDecimal> decimals)
        {

            List<string> deweys = new List<string>();
            List<DeweyDecimal> d = new List<DeweyDecimal>();

            foreach (var dec in decimals)
            {
                deweys.Add(dec.Decimal + " " + dec.Author);
            }
        ...
        private void CheckOrder()
        {
            ...
            try
            {
                ...
                if (equal)
                {
                    ...
                    this.NavigationService.Navigate(new Complete(currentTime, orderedDeweyDecimalsString));
                }
        ...
        private void GenerateBooks()
        {
            ...
            for (int i = 0; i < randomValue; i++)
            {
                ...
                decimals.Add(new DeweyDecimal()
                {
                    Decimal = decimals[index].Decimal,
                    Author = RandomString(3)
                });
            ...
            var orderedDeweyDecimals1 = decimals.OrderBy(f => f.Decimal);
            orderedDeweyDecimals = orderedDeweyDecimals1.ToList();
            ...
            foreach (var item in orderedDeweyDecimals)
            {
                ...
                orderedDeweyDecimalsString.Add(item.Decimal + " " + item.Author);

            }

            DeweyDecimal = new ObservableCollection<DeweyDecimal>(decimals.OrderBy(a => Guid.NewGuid()));
