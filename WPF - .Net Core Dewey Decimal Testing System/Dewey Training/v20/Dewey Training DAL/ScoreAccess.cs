    ...
    public class ScoreAccess
    {
        ...
        public bool CreateAreasScore(Score score)
        {
            ...
            try
            {
                ...
                // SQL Command
                string sql = $"INSERT INTO AreasScores(Username, UserTime, UserScore, DateTime)" +
                             $"VALUES('{score.Username}', '{score.UserTime}', '{score.UserScore}', '{score.DateTime}')";
        ...
        // Creates the score in the database
        public bool CreateFindCallNumberScore(Score score)
        {
            ...
            try
            {
                ...
                // SQL Command
                string sql = $"INSERT INTO FindCallNumberScores(Username, UserTime, UserScore, DateTime)" +
                             $"VALUES('{score.Username}', '{score.UserTime}', '{score.UserScore}', '{score.DateTime}')";
        ...
        public List<Score> ReadAreasScores()
        {
            ...
            if (reader.HasRows)
            {
                while (reader.Read())
                {
                    ...
                    {
                        Username = reader.GetString(0),
                        UserTime = reader.GetString(1),
                        UserScore = reader.GetString(2),
        ...
        // Gets the scores for the passed username
        public List<Score> ReadFindCallNumberScores()
        {

            // SQL Command
            string sql = "SELECT * FROM FindCallNumberScores;";
